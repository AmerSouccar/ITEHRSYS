...
import { LeaveRequestServiceComponent } from './leave-request-service/leave-request-service.component';
...
@NgModule({
    declarations: [
        ...
        LeaveRequestServiceComponent,
        AcceptLeaveRequestServiceComponent,
