...
using HRSystem.Models.TokenAuth;
...
{
    public abstract class HRSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HRSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HRSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HRSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HRSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HRSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HRSystemDbContext, Task<T>> func)
        {
            T result;
